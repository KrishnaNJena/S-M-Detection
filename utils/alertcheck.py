...
def drawboxtosafeline(image_np,p1,p2,Line_Position2,Orientation):
    ...
    if (distance_from_line <= 0) :
			 ...
			 #sound = os.path.join()D:\DSP\Deep_Learning\Notes\Data_Science\INeuron\Project\aHAND DETECT\shredder-machine-hosur\utils\alert.wav
             playsound(r"D:\DSP\Deep_Learning\Notes\Data_Science\INeuron\Project\HAND DETECT\shredder-machine-hosur\utils\alert.wav")
